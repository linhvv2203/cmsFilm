<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_Menu.aspx.cs" Inherits="SYS_user_Menu" %>
<HTML>
	<HEAD>
		<title></title>
				...
				<TBODY>
				    ...
				    <tr>
							<td width="100%" bgColor="#F0EDE1" valign="middle" height="30">&nbsp;<img src="../images/selectimage.gif" width="20" height="20" align=absbottom />
							    ...
							    <b>
                                <asp:label id="Label2" runat="server" Font-Size="10pt" Font-Bold="True">DANH SÁCH MENU</asp:label>&nbsp;
