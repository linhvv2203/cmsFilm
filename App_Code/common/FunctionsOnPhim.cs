...
namespace VatLidOnPhim
{
    ...
    public class DAL
    {
        ...
        private static string ConnOnPhimLog = SecureConnection.GetCnxStringDecode("ConnOnPhimLog");
        private static string ConnOnPhimGate = SecureConnection.GetCnxStringDecode("ConnOnPhimGate");
        private static string ConnOnPhimGatelog = SecureConnection.GetCnxStringDecode("ConnOnPhimGatelog");
        public static string ConnDoisoat = SecureConnection.GetCnxStringDecode("ConnDoisoat");
        ...
        {
            string FileName = VatLidOnPhim.Utils.GetFileWithParam(request);
        ...
        {
            FuncFile = VatLidOnPhim.Utils.KillChars(FuncFile);
        ...
        public static string getConnectionStringOnPhimLog()
        {
            return ConnOnPhimLog;
        }

        public static string getConnectionStringPhimGate()
        {
            return ConnOnPhimGate;
        }

        public static string getConnectionStringPhimGateLog()
        {
            return ConnOnPhimGatelog;
        }
        ...
        public static string Validate_input_values(string values, string type)
        {
            string result = "0";
            DataSet ds = null;
            try
            {
                ...
                ds = VatLidOnPhim.DAL.GetDataSet("sp_validate_input_values", cmd);
        ...
        /// <returns></returns>
        public static string getId_fromName(string name, string procedures)
        {
            string result = "0";
            DataSet ds = null;
            try
            {
                ...
                ds = VatLidOnPhim.DAL.GetDataSet(procedures, cmd);
                if (ds.Tables[0].Rows.Count > 0)
                {
                    result = ds.Tables[0].Rows[0][0].ToString();
                }
        ...
        {
            using (SqlConnection conn = new SqlConnection(ConnOnPhim))
            {
                cmd.Connection = conn;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = store;
        ...
        public static string Insert_FromMOHUY_OnPhim(int ID)
        {
            string tmp2 = "Exec dbo.Insert_FromMOHUY_OnBox {0}";
            string SQL = string.Format(tmp2, ID);
            return ExecuteQuery_ConnOnPhimGate(SQL);
        }
        ...
        private static string ExecuteQuery_ConnOnPhimLog(string SQL)
        {
            int sResult = 0;
            using (SqlConnection conn = new SqlConnection(ConnOnPhimLog))
            using (SqlCommand cmd = new SqlCommand(SQL, conn))
            {
                try
                {
        ...
        private static string ExecuteQuery_ConnOnPhimGate(string SQL)
        {
            int sResult = 0;
            using (SqlConnection conn = new SqlConnection(ConnOnPhimGate))
            using (SqlCommand cmd = new SqlCommand(SQL, conn))
            {
                try
                {
        ...
        private static string ExecuteQuery_ConnOnPhimGatelog(string SQL)
        {
            int sResult = 0;
            using (SqlConnection conn = new SqlConnection(ConnOnPhimGatelog))
            using (SqlCommand cmd = new SqlCommand(SQL, conn))
            {
                try
                {
        ...
        public static int GetParnerIDFromUserLogin(string user)
        {
            try
            {
                ...
                DataSet ds = VatLidOnPhim.SqlHelper.ExecuteDataset(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.Text, sql);
        ...
        public static string getGamePartID(Object objurl)
        {
            ...
            if (dl != null)
            {
                ...
                String[] dl1 = VatLidOnPhim.DAL.GetDataReaderToStringList(sql);
                if (dl1 != null)
                {
                    return dl1[0];
                }
        ...
        public static void FillDataToDropdownList_OnKid(DropDownList ddlList, string TableName, string FieldList, string where)
        {
            ...
            try
            {
                ds = VatLidOnPhim.DAL.GetDataSet("[CMS_FillDataToDropdownList_v2]", cmd);
                if (ds.Tables[0].Rows.Count > 0)
                {
        ...
        public static void FillDataToDropdownListAll(DropDownList ddlList, string TableName, string FieldList)
        {
            ...
            try
            {
                conn = new SqlConnection(ConnOnPhim);
        ...
        public static DataView CreateDataView_SMSGATE(string SQL)
        {
            SqlConnection conn = null;
            try
            {
                conn = new SqlConnection(ConnOnPhimGate);
                SqlDataAdapter da = new SqlDataAdapter(SQL, conn);
        ...
        public static DataView CreateDataView_SMSGATELOG(string SQL)
        {
            ...
            try
            {
                conn = new SqlConnection(ConnOnPhimGatelog);
                SqlDataAdapter da = new SqlDataAdapter(SQL, conn);
                DataTable dt = new DataTable();
                da.Fill(dt);
                return dt.DefaultView;
        ...
        public static DataView CreateDataView_LogXemdi(string SQL)
        {
            ...
            try
            {
                conn = new SqlConnection(ConnOnPhimLog);
                SqlDataAdapter da = new SqlDataAdapter(SQL, conn);
                DataTable dt = new DataTable();
                da.Fill(dt);
                return dt.DefaultView;
        ...
        public static void FillDataToCheckboxlist(CheckBoxList chkbList, string TableName, string FieldList)
        {
            string SQL = "SELECT " + FieldList + " FROM " + TableName;
            string[] arrField;
            arrField = FieldList.Split(',');
            ...
            try
            {
                ...
                chkbList.DataMember = TableName;
                chkbList.DataValueField = arrField[0];// Field1;
                chkbList.DataTextField = arrField[1];// Field2;			
                chkbList.DataBind();
            }
            catch (Exception e)
            {
        ...
        {
            return GetDataSet(store, ConnOnPhim, cmd);
        }
        public static void FillDataToDropdownListStore(DropDownList ddlList, string Store, string FieldList, string where)
        {
            ...
            try
            {
                ds = VatLidOnPhim.DAL.GetDataSet(Store, cmd);
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ddlList.DataSource = ds.Tables[0];
        ...
        public static void FetchDataGridColumnFormatLast(System.Web.UI.WebControls.DataGrid dg, string HeaderText, string DataTextField, string DataTextFormatString)
        {
            HyperLinkColumn hlc = new HyperLinkColumn();
            ...
            hlc.DataTextField = DataTextField;
            hlc.DataTextFormatString = DataTextFormatString;
            dg.Columns.AddAt(dg.Columns.Count - 1, hlc);
        ...
        public static void ChangeDataGridColumn(System.Web.UI.WebControls.DataGrid dgr, int iColumn, string sOldContent, string sNewContent)
        {
            ...
            for (i = 0; i < dgr.Items.Count; i++)
            {
                ...
                VatLidOnPhim.MessageBox.Show(dgr.Items[i].Cells[iColumn].Text);
        ...
        public static void UpdateStatus(string sTableName, string sFieldName, int intvalue, string sID)
        {
            ...
            try
            {
                ...
                if (strDSTableSYNC.IndexOf("," + sTableName + ",") >= 0)
                {
                    ...
                    VatLidOnPhim.DAL.ExecuteQuery(updateSQL);
                }
            }
            catch (Exception e)
            {
        ...
        public static string InsertUpdateVoteImage(string ItemCode, string UserID, int week, string date)
        {
            ...
            try
            {
                ...
                DataSet ds;
                ds = VatLidOnPhim.SqlHelper.ExecuteDataset(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "select_IMAGE_VOTE_ByItemCode", parameters2);
        ...
        public void UpdateFileName(string id, string strFileName)
        {
            ...
            VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "Cho_UpdateFileName", parameters);
        }
        ...
        public static string getCategoryID(string CategoryName)
        {
            ...
            try
            {
                ...
                DataSet ds;
                ds = VatLidOnPhim.SqlHelper.ExecuteDataset(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "select_CategoriesMenu_ByName", parameters);
        ...
        public static string getDownloadMessages(string ServiceID, string CommandCode, string Info, string UserID)
        {
            ...
            try
            {
                ...
                result = VatLidOnPhim.DAL.GetDataToString(SQL);
        ...
        //        VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "insert_SMS_LOG_WEB", parameters);
        //    }
        ...
        public static void INSERT_USER_USE_WAP(string UserID, string ItemID, int type)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "sp_insert_User_wap", parameters);
            }
        ...
        public static void INSERT_USER_USE_WAP_SO(string UserID, string ItemID, int type)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "sp_insert_User_wap_nhacso", parameters);
            }
        ...
        public static void INSERT_USER_USE_WAP_Chuong(string UserID, string ItemID, int type)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "sp_insert_User_wap_chuong", parameters);
            }
        ...
        public static void INSERT_USER_USE_WAP_QUATANG(string UserID, string ItemID, int type)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "sp_insert_User_wap_Quatang", parameters);
            }
        ...
        public static void INSERT_USER_USE_WAP_RADIO(string UserID, string ItemID, int type)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "sp_insert_User_wap_Radio", parameters);
            }
        ...
        public static void INSERT_USER_USE_WAP_ISTORY(string UserID, string ItemID, int type)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "sp_insert_User_wap_Istory", parameters);
            }
        ...
        public static void INSERT_USER_USE_WAP_THEOTEN(string UserID, string ItemID, int type)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "sp_insert_User_wap_TheoTen", parameters);
            }
        ...
        public static void INSERT_USER_USE_WAP_THIEPNHAC(string UserID, string ItemID, int type)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "sp_insert_User_wap_ThiepNhac", parameters);
            }
        ...
        public static void INSERT_USER_USE_WAP_FLASH(string UserID, string ItemID, int type)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "sp_insert_User_wap_Flash", parameters);
            }
        ...
        public static void INSERT_USER_USE_WAP_COMIC(string UserID, string ItemID, int type)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "sp_insert_User_wap_Comic", parameters);
            }
        ...
        public static void INSERT_USER_USE_WAP_VIDEO(string UserID, string ItemID, int type)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "sp_insert_User_wap_Video", parameters);
            }
        ...
        public static void INSERT_USER_USE_WAP_HAD(string UserID, string ItemID, int type)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "sp_insert_User_wap_HAD", parameters);
            }
        ...
        public static void INSERT_USER_USE_WAP_HAN(string UserID, string ItemID, int type)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "sp_insert_User_wap_HAN", parameters);
            }
        ...
        //        VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "insert_NHACCHUONG", parameters);
        ...
        public static void insert_XNKLOG(string ReceiverID, string UserID, string ItemCode, string ItemName, string SingerName, string Price, string Cpname, string type)
        {
            ...
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "insert_XNKLOG", parameters);
        ...
        public static void INSERT_LOG_WAP(string UserID, string Name, string mobile)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "insert_USER_WAP_LOG", parameters);
            }
            catch (Exception ex)
            {
                VatLidOnPhim.DAL.ExceptionProcess(ex);
        ...
        public static void GoiVideoTuan_Update(int id, int type)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "ItemVideoSubTuan$Update", parameters);
            }
            catch (Exception ex)
            {
                VatLidOnPhim.DAL.ExceptionProcess(ex);
        ...
        public static void VideoHotChuDe_Update(int id, int cid, int type)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "SubVideoHot$Update", parameters);
        ...
        public static void Insert_ComicSub(string ids, int CategoryID)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "ItemComicSub$SetBatch", parameters);
            }
        ...
        public static void Insert_ItemVideoSubVD3(string ids)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "ItemVideoSubVD3$SetBatch", parameters);
            }
        ...
        public static void Insert_ItemVideoTaoQuan(string ids)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "ItemVideoTaoQuan$SetBatch", parameters);
            }
        ...
        {
            //Html = VatLidOnPhim.Utils.KillChars1(Html);
            //Html = Html.Replace("http://115.84.178.52/", "./");
            Html = Html.Replace(VatLidOnPhim.Variables.sLinkToResource, "./");
            Html = Html.Replace("../../../archive/images", "./archive/images");
            Html = Html.Replace("../../archive/images", "./archive/images");
            Html = Html.Replace("../archive/images", "./archive/images");

            Html = Html.Replace(VatLidOnPhim.Variables.sLinkToResource + "archive/images", "/archive/images");

            //Html = Html.Replace("/cms/archive/images", "./archive/images");
            Html = Html.Replace("/mcontent/archive/images", "./archive/images");
            Html = Html.Replace("/archive/images", "./archive/images");
            //Html = Html.Replace("/archive/flashs", VatLidOnPhim.Variables.sLinkToResource +"archive/flashs");
            //Html = Html.Replace("/archive/files", VatLidOnPhim.Variables.sLinkToResource +"archive/files");
            Html = Html.Replace("./archive/media", VatLidOnPhim.Variables.sLinkToResource + "archive/media");
        ...
        {
            string s = VatLidOnPhim.Variables.sLinkToResource + "image/";
            ...
            Html = Html.Replace("./archive/images", "/archive/images");
            Html = Html.Replace(".../http://", "http://");
            Html = Html.Replace("/archive/images", VatLidOnPhim.Variables.sLinkToResource + "archive/images"); //swich to new ip
            // Html = Html.Replace("/cms", "");
        ...
        {
            DataSet mDataSet = null;
            SqlConnection conn = new SqlConnection(ConnOnPhim);
        ...
        public static void INSERT_ItemVideoHistory(int VID, int CategoryStatus, string UserLogin, string Description)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "insert_ItemVideoHistory", parameters);
            }
        ...
        public static void INSERT_USER_LOG_NEW(string UserID, string ActionName, string ActionDesc, string ActionStatus, string ActionID, string ip)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "insert_ACTION_LOG_NEW", parameters);
            }
        ...
        public static void UserLogs_InsertBatch(int uid, string userName, string mids, int type)
        {
            try
            {
                ...
                VatLidOnPhim.SqlHelper.ExecuteNonQuery(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure,
        ...
        public static int CheckMeNu(string MenuID, string UserID)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@UserID", UserID);
                DataSet ds = VatLidOnPhim.DAL.GetDataSet("CheckMeNu", VatLid.DAL.getConnectionString1(), cmd);
        ...
        public static string EpisodeAction(string ID, string Episode)
        {
            string URL = "";
            try
            {
                SqlCommand cmd = new SqlCommand();
                cmd.Parameters.AddWithValue("@ID", Convert.ToInt32(ID.Trim()));
                cmd.Parameters.AddWithValue("@Episode", Convert.ToInt32(Episode.Trim()));
                ///string cache_name = "Select_Group_GetURLVideoEpisode_film_" + ID + "_" + Episode;

                DataSet ds = VatLidOnPhim.DAL.GetDataSet("Select_Group_GetURLVideoEpisode_CMS", VatLidOnPhim.DAL.getConnectionStringOnPhim(), cmd);
                if (ds.Tables[0].Rows.Count > 0)
                {
        ...
        public static string EpisodeAction_OnKeeng(string ID, string Episode)
        {
            string URL = "";
            try
            {
                ...
                DataSet ds = VatLidOnPhim.DAL.GetDataSet("Select_Group_GetURLMovieEpisode_CMS", VatLidOnPhim.DAL.getConnectionStringOnPhim(), cmd);
                if (ds.Tables[0].Rows.Count > 0)
                {
                    URL = ds.Tables[0].Rows[0][0].ToString();
                }
