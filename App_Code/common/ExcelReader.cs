...
namespace VatLid
{
    public class ExcelReader : IDisposable
    {
        ...
        {
            if(_strExcelFilename.Contains(".xlsx"))
                return 
...
//        }
        ...
        //        Compatibility.Linq(allParts).Where(delegate(PackagePart x){ return x.ContentType.Equals("application/vnd.openxmlformats-officedocument.spreadsheetml.sharedStrings+xml")})};
 
        //        //PackagePart sharedStringsPart = Compatibility.Linq (allParts)   (from part in allParts
