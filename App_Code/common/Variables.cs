...
namespace VatLid
{
	...
	{
        public static string ImageLinksEdit = "../images/Edit.gif";
        ...
        public static string ImageUrl_CategoriesIcon = ConfigurationSettings.AppSettings["ImageUrl_CategoriesIcon"];

        public static string ImageLink3 = VatLid.Variables.sWebRoot + "images/button.gif";

        public static string EditTitle = "<img src='" + VatLid.Variables.sWebRoot + "images/Edit.gif' border=0 title='Edit' WIDTH='16' HEIGHT='16'></img>";
        public static string RenameTitle = "<img src='" + VatLid.Variables.sWebRoot + "images/copy.gif' border=0 title='Rename' WIDTH='16' HEIGHT='16' ></img>";
        public static string DeleteTitle = "<img src='" + VatLid.Variables.sWebRoot + "images/delete.gif' border=0 title='Delete' WIDTH='16' HEIGHT='16' ></img>";

		public static string PermissionTitle="<img src='" + VatLid.Variables.sWebRoot + "images/user.gif' border=0 title='Phân quyền'></img>";
		public static string ViewTitle="<img src='" + VatLid.Variables.sWebRoot + "images/bullet.gif' border=0 title='View'></img>";
		public static string DemoMusic="<img src='" + VatLid.Variables.sWebRoot + "images/icon-speaker_blue.gif' border=0 title='Nghe thử'></img>";
		public static string NoteNhac="<img src='" + VatLid.Variables.sWebRoot + "images/notnhac.gif' border=0 title='Nghe thử'></img>";
		public static string ActionTitle="<img src='" + VatLid.Variables.sWebRoot + "images/icon_inbox.gif' border=0 title='Chức năng'></img>";
		public static string ChooseTitle="<img src='" + VatLid.Variables.sWebRoot + "images/user.gif' border=0 title='Chọn khách hàng'></img>";
        ...
        public static string ImageCK1 = VatLid.Variables.sWebRoot + "images/button.gif";
        public static string ImageCK2 = VatLid.Variables.sWebRoot + "images/button.gif";
