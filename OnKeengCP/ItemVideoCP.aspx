<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ItemVideoCP.aspx.cs" Inherits="DOWNLOAD_ItemVideo" %>
                ...
                <asp:DataGrid ID="dgrCommon" runat="server" CssClass="GridLabel" Width="100%" AlternatingItemStyle-BackColor="lightgray"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a href="ItemMovie_DataCP.aspx?id=<%# Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "id").ToString())%>&type=edit&status=<%# Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "ItemStatus").ToString())%>">
            ...
            <div class="col-sm-12">
                ...
                <asp:Button ID="cmdSetShowHome" runat="server" CssClass="formSubmitBtn" Text="Duyệt"
                    Font-Bold="True" OnClick="cmdSetShowHome_Click" Height="20px"></asp:Button><asp:Button
                        ID="cmdRemove" runat="server" CssClass="formSubmitBtn" Text="Chờ duyệt" Font-Bold="True"
