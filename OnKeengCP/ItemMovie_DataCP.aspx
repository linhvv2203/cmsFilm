<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ItemMovie_DataCP.aspx.cs" Inherits="MOVIE_ItemMovie_Data" %>
    ...
    <div class="container">
        <form id="Form1" runat="server" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <asp:TextBox runat="server" ReadOnly="true" ID="txtPartner"></asp:TextBox>
                </div>
            </div>
                ...
                <div class="col-sm-4">
                    ...
                    <div id="showcate" style="display: none;">
                        ...
                        <asp:CheckBoxList ID="chkbCategory" runat="server" RepeatColumns="5">
                            <%--<asp:ListItem Text="Alabama" Value="1"></asp:ListItem>--%>
                        </asp:CheckBoxList>
                    </div>
                </div>
            </div>
            ...
            <%--<div class="form-group">
                <div class="row">
                    <div class="col-sm-offset-2">
                        ...
                        <label class="checkbox-inline">
                            <asp:CheckBox runat="server" ID="chkIsFree" />Film Free
                        </label>
                        <label class="checkbox-inline">
