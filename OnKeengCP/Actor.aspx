<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Actor.aspx.cs" Inherits="OnPhim_Actor" %>
...
function OnSetRelate() {
    ...
    sHtml = sHtml.trim();
    var s;
    s = window.opener.document.getElementById('txtActor').value;
    s = s.trim();
    if (s.length > 0)
        s = s + ',' + sHtml;
    else
        s = s + sHtml;
    window.opener.document.getElementById('txtActor').value = s;
...
Width="108px" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged" ></asp:dropdownlist> 	
                                            ...
                                            <input type="button" runat="server" id="cmdok" onclick="OnSetRelate()" value="Get Actor"
