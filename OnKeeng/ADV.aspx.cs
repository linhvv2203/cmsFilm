...
public partial class OnKeeng_ADV : System.Web.UI.Page
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        Status = (Request.QueryString["Status"] == null) ? "2" : Request.QueryString["Status"];
        strPartnerID = (Request.QueryString["PartnerD"] == null) ? "0" : Request.QueryString["PartnerD"];
    ...
    private DataSet Builfilter()
    {
        ...
        ds = VatLidOnPhim.DAL.GetDataSet("cms_getADV", cmd);
    ...
    {
        Response.Redirect("ADV_Data.aspx");
    }
}
