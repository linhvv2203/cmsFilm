...
public partial class OnKeeng_PlayVideoIntro : System.Web.UI.Page
{
    ...
    private void getData(string id)
    {
        try
        {
            ...
            DataSet ds;
            ds = VatLidOnPhim.SqlHelper.ExecuteDataset(VatLidOnPhim.DAL.getConnectionStringOnPhim(), CommandType.StoredProcedure, "getItemmovie_intro_Detail", parameters);
