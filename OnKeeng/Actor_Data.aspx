<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Actor_Data.aspx.cs" Inherits="OnPhim_Actor_Data" %>
...
<body>
    <form id="Form1" runat="server" class="form-horizontal">
        ...
        <div class="form-group">
            <label class="control-label col-sm-2" for="txtName">Tên Actor:</label>
            <div class="col-sm-4">
