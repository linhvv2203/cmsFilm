<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListMovieStatistics.aspx.cs" Inherits="OnKeeng_ListMovieStatistics" %>
...
<body>
    <div class="container">
        <h2 style="text-align: center;">THỐNG KÊ KHO PHIM</h2>
                ...
                <asp:DataGrid ID="dgrCommon" runat="server" CssClass="GridLabel" Width="100%" AlternatingItemStyle-BackColor="lightgray"
                    ...
                    <Columns>
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <p>
                                    <%# Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "CPName").ToString())%>
                                </p>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <p>
                                    <%# Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "FilmUpLoad").ToString())%>
                                </p>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <p>
                                    <%# Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "FilmApprove").ToString())%>
                                </p>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <p>
                                    <%# Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "FilmApproveAllCP").ToString())%>
                                </p>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                    </Columns>
