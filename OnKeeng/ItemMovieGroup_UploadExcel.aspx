<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ItemMovieGroup_UploadExcel.aspx.cs"
    Inherits="OnKeeng_ItemMovieGroup_UploadExcel" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        $('#id-filetem').click(function () {
            window.location = "../doc/itemMovieGroup.xlsx";
        });
    </script>
</body>
</html>
