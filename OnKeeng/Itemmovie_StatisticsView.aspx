<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Itemmovie_StatisticsView.aspx.cs" Inherits="OnKeeng_Itemmovie_StatisticsView" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>THỐNG KÊ LƯỢT XEM</title>
...
<body>
    <div class="container">
        <h2 style="text-align: center;">THỐNG KÊ LƯỢT XEM</h2>
        <asp:Label runat="server" ID="lblError" Font-Bold="true" ForeColor="Red"></asp:Label>
        <form id="form1" runat="server" class="form-inline">
            <div class="form-group" id="partnerInfo" runat="server">
                ...
                <asp:DataGrid ID="dgrCommon" runat="server" CssClass="GridLabel" Width="100%" AlternatingItemStyle-BackColor="lightgray"
                    ...
                    <Columns>
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <p>
                                    <%# Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "createdday").ToString())%>
                                </p>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <p>
                                    <%# Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "CpUpload").ToString())%>
                                </p>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <p>
                                    <%# Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "VideoName").ToString())%>
                                </p>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <p>
                                    <%# Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "Quantity").ToString())%>
                                </p>
                            </ItemTemplate>
                        </asp:TemplateColumn>
