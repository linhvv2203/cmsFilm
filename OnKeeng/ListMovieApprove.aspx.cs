...
public partial class OnKeeng_ListMovieApprove : System.Web.UI.Page
{
    ...
    private DataSet BuildFilter()
    {
        ...
        try
        {
            ...
            ds = VatLidOnPhim.DAL.GetDataSet("cms_Itemmovie_byCP_Date", cmd);
        }
        catch
        {
            return null;
    ...
    protected void btnExportExcel_Click(object sender, EventArgs e)
    {
        if (BuildFilter() != null)
        {
            ExportToExcel(BuildFilter(), "ListMovieApprove.xls");
