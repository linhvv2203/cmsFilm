<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListMovieApprove.aspx.cs" Inherits="OnKeeng_ListMovieApprove" %>
...
<body>
    <div class="container">
        <h2 style="text-align: center;">DANH SÁCH PHIM ĐÃ DUYỆT</h2>
        <form id="form1" runat="server" class="form-inline">
            ...
            <div>
                <%--<asp:CompareValidator ID="cvtxtStartDate" runat="server"
                    ControlToCompare="txtDateStart" CultureInvariantValues="true"
                ...
                <asp:DataGrid ID="dgrCommon" runat="server" CssClass="GridLabel" Width="100%" AlternatingItemStyle-BackColor="lightgray"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <p>
                                    <%# Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "nameCP").ToString())%>
                                </p>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <p>
                                    <%# Server.HtmlEncode(DataBinder.Eval(Container.DataItem, "expiredlicense").ToString())%>
                                </p>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn>
