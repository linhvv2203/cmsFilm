...
function selectAct(type,id)
{
    ...
    switch(type)
    {
         ...
         case "PopPhotoUsers":
            url='../XNKUSER/PopupTextHA.aspx?id='+id;
            size='top=100,left=300,height=300,width=310,scrollbars=0,toolbar=0,location=0';
            break;
          case "PopPhotoView":
            url='Users/PopPhotoView.aspx?id='+id;
            size='top=100,left=300,height=300,width=300,scrollbars=0,toolbar=0,location=0';
            break;
